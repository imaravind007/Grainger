...
def mask_detect(frameval, faceval, maskval):
...
prototexttPath = os.path.sep.join([args["face"], "deploy.prototxt"])
wp = os.path.sep.join([args["face"], "res10_300x300_ssd_iter_140000.caffemodel"])
faceNet = cv2.dnn.readNet(prototexttPath, wp)
